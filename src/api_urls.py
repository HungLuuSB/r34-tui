...
from __vars__ import __base_url__, __api_url__
...
class API_URLS(str, Enum):
    ...
    USER_FAVORITES = (
        f"{__api_url__}index.php?page=favorites&s=view&id={{USR_ID}}"  # returns: HTML
    )
    ...
    USER_PAGE = (
        f"{__api_url__}index.php?page=account&s=profile&id={{USER_ID}}"  # returns: HTML
    )
